// File created from user_chk_messages.mes on Mon Jan 20 2020 14:03
...
extern const isc::log::MessageID USER_CHK_MULTIPLE_RESULT_ENTRIES_RECEIVED = "USER_CHK_MULTIPLE_RESULT_ENTRIES_RECEIVED";
